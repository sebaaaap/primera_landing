export default function Location() {
  ...
  return (
    <section className="py-16 bg-neutral-light" id="ubicacion">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="mt-4 inline-flex items-center bg-primary text-white px-4 py-2 rounded-lg hover:bg-accent transition-colors"
              >
